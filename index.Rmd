...
.left[
# Functional Seizures & Other Functional Neurological Symptoms
]
...
.pull-right[
# <img style="border-radius: 50%;" alt = "Picture of presenter 2" src="https://i1.rgstatic.net/ii/profile.image/796176408383488-1566834656048_Q512/Gregg-Rawlings-3.jpg" width="180px"/>
## Gregg Rawlings
...
- .Large[Emotionally pertinent areas] `r icons::icon_style(icons::fontawesome("frown-open", style = "solid"), scale = 1.5, fill = "white")` 
- .Large[Potentially distressing videos] `r icons::icon_style(icons::fontawesome("video", style = "solid"), scale = 1.5, fill = "white")`
- .Large[Not about changing protocol] `r icons::icon_style(icons::fontawesome("hand-paper", style = "solid"), scale = 1.5, fill = "white")`
...
.pull-left[
.large[
- [**What is NEAD and FND?**](#what-slide) .blue[09:30-10:00]
- [**Why and What is Happening?**](#why-slide) .blue[10:30-10:30]
- [**Experience**](#experience-slide) .blue[10:45-11:15]
- [**Therapeutic Approach**](#therapeutic-slide) .blue[11:15-11:45]
- [**Case Examples**](#examples-slide) .blue[11.45-12:30]
- [**Resources**](#resources-slide)
]

.footnote[
Note: **Headings** are internal links.

A <a href="https://github.com/chris-gaskell/fnd-for-paramedics/blob/main/output/index.pdf">pdf of this presentation</a> `r icons::icon_style(icons::fontawesome("file-pdf", style = "solid"), scale = 1.5, fill = "black")` is also available.
]]
...
.pull-left[
`r embed_youtube("Dy3XLo7dVQI", width = 475, height = 275) %>% use_start_time("0m04s")`
...
???
- conversion disorder seldom used anymore. conversion of emotional distress into physical symptoms. 
...
???
When thinking about non-epileptic or functional seizures we are often referring to people experiencing a temporary loss of consciousness. Most specifically on this diagram we are thinking about the psychological causes of transient loss of consciousness.
...
1. **Psychiatric comorbdity**
  ...
  1. PTSD/Trauma
1. More likely to: be **white, unemployed, lower SES, have an LD**.
...
.pull-left[
- Review captured experiences of at least 3900 healthcare professionals from at least 63 different counties
- Responses demonstrated uncertainty about many aspects of NEAD
- NEAD considered challenging and frustrating
- Mixed views about who is responsible for treating patients with NEAD
]
...
- How might this affect the care that people with NEAD receive?
...
2. *Q: What are the unhelpful things you could do?*
]
