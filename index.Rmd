...
.left[#Non-Epileptic Attacks & Other Functional Neurological Disorders

.pull-left[An introduction to working with non-epileptic attacks and other functional neurological presentations
...
.pull-right[
<img style="border-radius: 50%;" src="https://i1.rgstatic.net/ii/profile.image/796176408383488-1566834656048_Q512/Gregg-Rawlings-3.jpg" width="150px"/>
## Gregg Rawlings
...
.white[.left[`r icons::icon_style(icons::fontawesome("frown-open", style = "solid"), scale = 1.5, fill = "orange")` .Large[Emotionally pertinent areas]

`r icons::icon_style(icons::fontawesome("video", style = "solid"), scale = 1.5, fill = "orange")` .Large[Potentially distressing videos]


`r icons::icon_style(icons::fontawesome("hand-paper", style = "solid"), scale = 1.5, fill = "orange")` .Large[Not about changing protocol]
]]
...
.footnote[
.red[**Note**:]Headings are internal links.

This presentation is also available as a
<a href="https://chris-gaskell.github.io/uos-sced/output/index.pdf">pdf</a> `r icons::icon_style(icons::fontawesome("file-pdf", style = "solid"), scale = 1.5, fill = "black")`
]
...
- NEAD symptoms are not always the same
- Symptoms may change over time

.red[Gregg do you have any furthe info/papers?]
...
New paper from Norway <a href="https://onlinelibrary.wiley.com/doi/full/10.1111/epi.16949">Villagrán (2021) </a> - 23.8 per 100,000

---
# Who is most likely to be affected?

.red[breakdown of key variables for NEA and FND.]
...
.pull-right[
.red[Journey do diagnosis is very long...
Enter research here.
]]
...
New paper showing high rates of misdiagnosis (and treatment) <a href="https://jnnp.bmj.com/content/jnnp/early/2021/08/16/jnnp-2021-326443.full.pdf">Jungilligens (2021) </a>... stats
...
`r embed_youtube("lAtW7nJUcRA", width = 800, height = 550) %>% use_start_time("2m54s")`
